...
const Menu = (): JSX.Element => {
    ...
    const { NewChild } = useSelector(({ Child }: any) => Child);
    ...
    const getKids = async () => {
        try {
            ...
            const promises = [
                dispatch<any>(ChildOperations.getChildren(search)),
                dispatch<any>(ChildOperations.getLastChildren()),
                dispatch<any>(ChildOperations.getLastChild())
            ];
